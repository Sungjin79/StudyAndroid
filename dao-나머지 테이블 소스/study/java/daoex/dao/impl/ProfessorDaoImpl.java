...
public class ProfessorDaoImpl implements ProfessorDao {
	...
	public int insert(Professor params) {
		...
		/** 실행할 SQL구문 정의 */
        String sql = "INSERT INTO Professor (profno, name, userid, position, "
        		+ "sal, hiredate, comm, deptno) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public List<Professor> select() {
		...
		// 'Professor'테이블에 데이터를 갱신하기 위한 SQL의 템플릿
